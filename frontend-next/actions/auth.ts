...
export async function loginUserAction(
  ...
  // Despues que se loguee, guardamos el JWT en una cookie y redirigimos al usuario a /dashboard
...
export async function registerUserAction(
  ...
  // Despues que se registre, guardamos el JWT en una cookie y redirigimos al usuario a /dashboard
  const cookieStore = await cookies();
  cookieStore.set("jwt", response.jwt, cookieConfig);
  redirect("/dashboard");
}
